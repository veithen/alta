...
public abstract class AbstractProcessMojo extends AbstractMojo {
    ...
    static {
        ...
        PropertyGroup<Context, Artifact> artifactGroup =
                new PropertyGroup<Context, Artifact>(Artifact.class) {
                    @Override
        ...
        PropertyGroup<Context, Bundle> bundleGroup =
                new PropertyGroup<Context, Bundle>(Bundle.class) {
                    @Override
    ...
    protected abstract void process(List<Artifact> artifacts)
    ...
    static File getArtifactFile(Artifact artifact) throws EvaluationException {
        ...
        if (file.isFile()) {
            ...
            throw new EvaluationException(
                    "Artifact has not been packaged yet; it is part of the reactor, but the package phase has not been executed.");
        }
    }
    ...
    protected static Template<Context> compileTemplate(String template, String name)
    ...
    protected static String evaluateTemplate(Template<Context> template, Artifact artifact)
            throws MojoExecutionException {
        try {
